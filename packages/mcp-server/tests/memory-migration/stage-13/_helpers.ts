/**
 * Shared helpers for Stage #13 vitest suites.
 * Duplicates the lightweight env-loader / tcpProbe pattern from Stage #8 so each stage's
...
/** Post-Sub-task-B skip-gate: probe whether a Qdrant collection still exists. */
